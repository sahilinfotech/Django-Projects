...
var KTCookie = function() {
    return {
        ...
        set: function(name, value, options) {
            ...
            if ( options.expirys instanceof Date ) {
                options.expirys = options.expirys.toUTCString();
            }
...
var KTAppLayoutBuilder = function() {
	...
	var handleEngagePrebuilts = function() {	
		...
		if ( KTCookie.get("app_engage_prebuilts_modal_displayed") !== "1" ) {
			setTimeout(function() {
				...
				KTCookie.set("app_engage_prebuilts_modal_displayed", "1", {expirys: date});
			}, 3000);
		} 
	}
	...
	var handleEngageToggle = function() {	
		engageToggleOff.addEventListener("click", function (e) {
			...
			KTCookie.set("app_engage_hide", "1", {expirys: date});
...
var KTAppSidebar = function () {
	...
	var handleToggle = function () {
		...
		toggleObj.on('kt.toggle.changed', function() {
			...
			KTCookie.set("sidebar_minimize_state", toggleObj.isEnabled() ? "on" : "off", {expirys: date}); 
		});
	}
