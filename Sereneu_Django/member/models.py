...
class FoldernameModel(models.Model):

    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True)
    foldername = models.CharField(max_length=255)
    created_at = models.DateTimeField(auto_now_add=True)
    
class FoderfilenameModel(models.Model):
    
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True)
    folderfile = models.FileField(upload_to='folderfile/')
    foldername = models.ForeignKey(FoldernameModel, on_delete=models.CASCADE, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    
class SchedularModel(models.Model):
    ...
    isschedular= models.BooleanField(default=False)
    created_at = models.DateTimeField(auto_now_add=True)
    

class ExamdetailsModel(models.Model):
